  ...
  return (
    <div className="relative" ref={boxRef}>
      ...
      <div className="relative">
        ...
        />
        <SearchIcon className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-gray-700 dark:text-gray-300" />
      </div>
...
function SectionHeader({ icon: Icon, label, hint }) {
  return (
    <div className="flex items-center gap-2 px-3 py-2 bg-gray-50/70 dark:bg-gray-800/60 border-b border-gray-200 dark:border-gray-800">
      ...
      <span className="ml-auto text-[11px] text-gray-700 dark:text-gray-300">
        {hint}
      </span>
    </div>
  );
