...
const DashBoardSideBar = () => {
  ...
  const menuItems = [
    { id: "dashboard", label: "Dashboard", icon: <Home className="size-5" />, path: "/dashboard" },
    ...
    { id: "vouchers", label: "Vouchers", icon: <Ticket className="size-5" />, path: "/dashboard/vouchers" },
    { id: "inventory", label: "Inventory", icon: <Box className="size-5" />, path: "/dashboard/inventory" },
