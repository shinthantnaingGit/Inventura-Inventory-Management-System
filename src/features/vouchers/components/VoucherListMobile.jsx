...
export default function VoucherListMobile({ vouchers }) {
  ...
  const handleDelete = (id, voucherId) => {
    showDialog({
      title: t("vouchers.confirm.header", "削除の確認"),
      description: t(
        "vouchers.confirm.message",
        `"{voucher_id}" を削除しますか？`
      ).replace("{voucher_id}", voucherId),
      confirmText: t("vouchers.confirm.accept", "削除する"),
      cancelText: t("vouchers.confirm.reject", "キャンセル"),
      onConfirm: async () => {
        try {
          ...
          >
            ...
            <div className="mt-4 flex items-center justify-center  gap-2">
              <Link
                ...
                className="inline-flex text-gray-700 dark:text-gray-300  items-center justify-center gap-1 rounded-lg border px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800"
              >
              ...
              <button
                ...
                className="text-gray-700 dark:text-gray-300 inline-flex items-center justify-center gap-1 rounded-lg border px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800"
              >
