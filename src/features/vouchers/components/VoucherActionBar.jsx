  ...
  return (
    <div className="mb-4 flex items-center gap-2">
      ...
      <div className="relative flex-1">
        <Search className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-gray-700 dark:text-gray-300" />
        <input
          ref={searchRef}
          type="text"
          placeholder={t(
          ...
          aria-label={t("voucherActionBar.searchAria", "バウチャーを検索")}
        />
        {/* Clear button */}
        <button
          type="button"
          onClick={handleClearSearch}
          className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-700 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100"
