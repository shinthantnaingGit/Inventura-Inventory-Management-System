          ...
          >
            ...
            <div className="mt-4 grid grid-cols-3 gap-2">
              <Link
                ...
                className="inline-flex text-gray-700 dark:text-gray-300  items-center justify-center gap-1 rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800"
              ...
              <Link
                ...
                className="text-gray-700 dark:text-gray-300 inline-flex items-center justify-center gap-1 rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800"
