  ...
  const features = [
    {
      ...
      description: t("landing.intro.features.inventory.desc", "製品の追加、編集、削除をリアルタイムの在庫追跡とともに行い、簡単に管理できます。"),
    },
    {
      icon: <FileText className="h-12 w-12 text-blue-500 mb-4 mx-auto" />,
      title: t("landing.intro.features.invoiceGen.title", "請求書生成"),
      description: t("landing.intro.features.invoiceGen.desc", "自動計算機能付きで、プロフェッショナルな印刷可能な請求書を素早く作成します。作成された請求書は請求書管理システムにも保存されます。"),
    },
    {
      icon: <ClipboardList className="h-12 w-12 text-blue-500 mb-4 mx-auto" />,
      title: t("landing.intro.features.invoiceMgmt.title", "請求書管理"),
      description: t("landing.intro.features.invoiceMgmt.desc", "すべての請求書を追跡し、支払い状況を管理し、請求履歴を簡単に整理します。"),
    },
    {
      icon: <BarChart2 className="h-12 w-12 text-blue-500 mb-4 mx-auto" />,
      title: t("landing.intro.features.analytics.title", "ダッシュボードと分析"),
      description: t("landing.intro.features.analytics.desc", "収益、売上、トップセラー製品のインタラクティブなチャートで貴重な洞察を得られます。"),
    },
  ];

  return (
    <section ref={introRef} id="intro" className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white py-20 lg:py-32 transition-colors duration-500">
